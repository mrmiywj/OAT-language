...
(* LLVM IR types *)
(* Note that I8* is used only for dealing with C-style string constants.
 * I1 is only for computing conditional tests.  Note that we'll compile 
 * I1 to 32-bit integers in Phase2. 
 *)
type ty =  
